            ...
            <div class="hero-content">
                <div class="hero-left">
                    ...
                    <div class="social-links">
                        ...
                        <a href="https://www.youtube.com/@minettekaum" target="_blank" rel="noopener noreferrer" aria-label="YouTube"><i class="fab fa-youtube"></i></a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="about-content">
                <div class="about-text">
                    ...
                    <ul>
                        ...
                        <li>Achieved an overall satisfaction score of 4.4/5 at all events.</li>
                    </ul>
        ...
        <section id="projects-section" class="projects" bind:this={sections[2]} class:visible={visibleSections[2]}>
            ...
            <div class="project-grid">
                {#each projects as project}
                    {#if project.liveUrl}
                        <a href={project.liveUrl} class="project-card" target="_blank" rel="noopener noreferrer">
                            <h3>{project.title}</h3>
